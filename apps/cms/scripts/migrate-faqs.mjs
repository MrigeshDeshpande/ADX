  ...
  fullstack: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The Full-Stack Web Development OJT program duration is 6 months.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "This is an offline classroom-based digital marketing course at SkillYards, Agra.",
      },
      {
        question: "What is the duration of the course?",
        answer:
          "The Digital Marketing OJT program duration is 6 months.",
      },
      {
