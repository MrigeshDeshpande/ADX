      ...
      <div className="flex items-end justify-between gap-4">
        <div>
          ...
          <h2 className="mt-3 font-serif text-3xl sm:text-4xl font-black text-foreground">
            Pillars and learning paths
          </h2>
        </div>
        <p className="max-w-md text-sm text-muted-foreground">
          Cornerstone reads built for exploration, not doom-scroll.
        </p>
      </div>
        ...
        <div className="mx-auto max-w-[1240px] space-y-16 px-6 sm:px-12">
          <div className="mx-auto max-w-4xl text-center">
            <p className="text-[11px] font-bold uppercase tracking-[0.28em] text-primary">
              SkillYards Editorial
            </p>
            <h1 className="mt-5 font-serif text-5xl font-black tracking-tight text-foreground sm:text-6xl">
              Learn path. Compare smart. Read news with context.
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
              Blog now split by intent: evergreen guides, decision content, and newsroom-style updates.
            </p>
          </div>
