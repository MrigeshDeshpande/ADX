...
const channels = [
    ...
    },
    {
        icon: <Mail size={22} />,
        label: "Email",
        value: process.env.NEXT_PUBLIC_EMAIL || "support@adhyayanx.in",
        meta: "Response within 24 hours",
        href: `mailto:${process.env.NEXT_PUBLIC_EMAIL || "support@adhyayanx.in"}`,
    ...
    },
    {
        ...
        href: "https://maps.google.com/?q=AdhyayanX+Agra",
