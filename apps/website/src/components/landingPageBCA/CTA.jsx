...
export const BCA_CTA = () => {
  return (
    <section className="py-12 md:py-20 w-full bg-background px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        <div className="relative rounded-2xl md:rounded-3xl overflow-hidden bg-primary text-primary-foreground">
          {/* Decorative circles */}
          ...
          <div className="relative z-10 p-6 sm:p-10 md:p-14 lg:p-16 text-center">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-extrabold leading-[1.1] tracking-tight mb-4 md:mb-6">
              ...
              <span className="italic">Tech Career?</span>
            </h2>

            {/* Description */}
            <p className="text-sm sm:text-base md:text-lg text-primary-foreground/80 max-w-2xl mx-auto leading-relaxed mb-8 md:mb-10">
              Join the only BCA program designed to build{" "}
              <span className="font-bold text-primary-foreground">industry-ready developers</span> and digital innovators.
            </p>
