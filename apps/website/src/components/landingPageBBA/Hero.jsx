            ...
            <div className="flex flex-col items-center  lg:items-start text-center lg:text-left">
              ...
              >
                <Link href="/contact" className="flex-1 sm:flex-initial">
                  <Button
                    size="lg"
                    className="w-full rounded-full bg-primary dark:bg-primary/90 text-primary-foreground px-4 sm:px-6 md:px-8 py-3 sm:py-5 md:py-6 text-xs sm:text-sm md:text-base font-extrabold hover:bg-primary/90 dark:hover:bg-primary/80 hover:scale-105 shadow-xl shadow-primary/20 transition-all"
                  >
